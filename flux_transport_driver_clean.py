...
from flux_transport_model_clean import flux_function, solving_loop, alpha_heating, bremsstrahlung, compute_face_flux

# ==========================================
# Run control
# ==========================================
SKIP_SOLVE = False          # True → load saved data, skip solver
DATA_FILE  = "plots/run_data.npz"
...
# ==========================================
from flux_transport_model_clean import _get_bcs, _apply_bc_to_profile
